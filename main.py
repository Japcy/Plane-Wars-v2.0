...
def add_mid_enemies(group1, group2, num):
    for i in range(num):
        e2 = enemy.Mid_enemy(bg_size)
        group1.add(e2)
        group2.add(e2)

def add_big_enemies(group1, group2, num):
    for i in range(num):
        e3 = enemy.Big_enemy(bg_size)
        group1.add(e3)
        group2.add(e3)
...
def main():
    ...
    # 每30秒发放一个补给包
    bullet_supply = supply.Bullet_suplly(bg_size)
    bomb_supply = supply.Bullet_suplly(bg_size)
    ...
    while running:
        ...
        # 绘制游戏结束画面
            ...
            # 绘制结束画面
            record_score_text = score_font.render("Best : %d" %
